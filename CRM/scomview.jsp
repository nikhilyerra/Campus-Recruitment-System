...
<th align="center"><h3><font color="orange">View</h3></th>
</tr>	
...
<td align="center"><p style="(255,0,255);"><font size="4"><a href="scomview1.jsp?aid=<%=rs.getString(1)%>&&email=<%=rs.getString(9)%>">view</a></font></p></td>
