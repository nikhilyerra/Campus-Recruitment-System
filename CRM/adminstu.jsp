...
rs=st.executeQuery(" select * from sregister where sstatus='approve' ");
...
<td align="center"><p style="(255,0,255);"><font size="4"><a href="adminstu1.jsp?aid=<%=rs.getString(1)%>&&email=<%=rs.getString(8)%>">Delete</a></font></p></td>
