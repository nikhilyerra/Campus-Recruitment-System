...
<th align="center"><h3><font color="orange">Status</h3></th>
 ...
 <%
				  ...
				  {
					  out.println("<script>alert('Company have permission to login...!')</script>");
				  }
%>
...
rs=st.executeQuery(" select * from cregister where cstatus='wait' ");
...
<td align="center"><p style="(255,0,255);"><font size="4"><a href="arequests4.jsp?aid=<%=rs.getString(1)%>&&email=<%=rs.getString(9)%>">Active</a></font></p></td>
