              ...
              <tr> 
                <td colspan="2" align="center"><font size="2"><b> 
				  ...
				  out.println("<script>alert('The Registration is  Failed ')</script>");
                                                       ...
                                                       if(id!=null )
                                                       {
                                                               out.println("<script>('Registration Success... !')</script> ");
                                                       }
													   else {%>
...
<h2>Register Here</h3></h2><br><br>
 <form name="reg" action="register2.jsp" method="get"   name="pwForm" >

 
             <table cellspacing="10">
              <tr> 
                <td>
                <input type="text" name="name" id = "name" onblur = "enableRegisterButton();" style="width: 350px;" required placeholder="Company Name">
              </tr>
...
<tr> 
			  ...
			  <tr> 
                <td><br>
                <input type="text" name="country" id = "name" onblur = "enableRegisterButton();" style="width: 350px;" required placeholder="Country">
              </tr>
